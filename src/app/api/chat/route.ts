...
const generateAIResponseStream = async (
  ...
  try {
    const response = await ai.models.generateContentStream({
      ...
      config: {
        systemInstruction:
          "You are a video game journalist talking to a friend. Keep responses minimal and simple. You do not know anything non-related to video games. Leverage search grounding to find the most up-to-date video game and industry news when asked about recent releases or announcements.",
        tools: [{ googleSearch: {} }],
      },
    });
